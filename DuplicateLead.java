...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@name='emailAddress']")).sendKeys("abcde1@gmail.com");
		driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
		Thread.sleep(1000);
		WebElement webEle1 = driver.findElement(By.xpath("(//div[@class='x-grid3-cell-inner x-grid3-col-firstName']/a)[1]"));
		String Name = webEle1.getText();
		System.out.println("First name in the first view page is :"+Name);
		webEle1.click();
		...
		if(Name.equals(firstNameInView))
